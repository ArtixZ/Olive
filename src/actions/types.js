...
export const CURRENT_NUTRITIONS_FOR_FOOD = 'CURRENT_NUTRITIONS_FOR_FOOD';
export const ACCUMULATE_NUTRITIONS = 'ACCUMULATE_NUTRITIONS';
export const SET_INITIAL_NUTRITION_HISTORY = 'SET_INITIAL_NUTRITION_HISTORY';
